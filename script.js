document.addEventListener("DOMContentLoaded", () => {
    ...
    // Connected Real-Time Apps Script Validation Link API URL
    ...
    function setupCanvas() {
        ...
        // Render Premium Realistic Brushed Silver Metallic Cover Texture
        ...
        // Texture Bold Metallic Text Overlays - SCRATCH HERE
        ctx.font = "italic 900 32px 'Poppins'";
        ctx.fillStyle = "#455a64";
        ctx.textAlign = "center";
        ctx.fillText("SCRATCH", canvas.width / 2, canvas.height / 2 - 8);
        ctx.fillText("HERE", canvas.width / 2, canvas.height / 2 + 28);
    ...
    function checkClearProgress() {
        ...
        if ((clearedPixels / (imgData.length / 4)) * 100 > 40) {
            ...
            // Instant script injection approach to burn parameters inside remote database sheets
